...
from PIL import ImageTk, ImageDraw, Image, ImageFont, ImageColor
...
if not debug:
    ...
    from themes.standard import STANDARD_THEMES
    from publisher import Publisher, Channel
